...
Это инструмент для разработчиков, интересующихся **game development tools**, **sprite animation** и обработкой изображений в C#. Идеальный **PNG atlas generator** где нужно быстро подготовить кадры анимации для Unity, Godot или веб-игр.
...
1. Скачайте релиз приложения из раздела [Releases](https://github.com/GeorgeMarinichev/GifToSprite/releases/tag/v1.0.0) на этой странице (файл с расширением .exe или аналогичным для вашей ОС).
